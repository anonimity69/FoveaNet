...
| Numerical comparison | 30 original/cleaned outputs matched exactly on synthetic input |
...
an overlap-ceiling calculation. It compared the pre-cleanup working files with
the cleaned files, not an older Git revision.
